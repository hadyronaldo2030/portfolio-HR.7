...
$(document).on('click', '.set-menu .color1', function(){
	$('body').removeClass('bg-dark');
	$('body').addClass('bg-white');
});
$(document).on('click', '.set-menu .color2', function(){
	$('body').addClass('bg-dark text-white');
});
$(document).on('click', '.set-menu .color3', function(){
	$('body').addClass('bg-dark text-white');
});
$(document).on('click', '.set-menu .color4', function(){
	$('body').addClass('bg-dark text-white');
});
$(document).on('click', '.set-menu .color5', function(){
	$('body').addClass('bg-dark text-white');
});
